...
本人热爱技术，具有扎实的专业基础，主要编程语言方向是Java，熟悉Java并发、JVM。熟悉SpringBoot、Mybatis、SpringCloud等主流框架。也做过一些项目，其中用java做的有基于springboot开发的科研系统平台，ehr人事系统。也有python语言的算法类项目，比如大数据异常分析、电磁信号识别等。

此次希望寻求一份Java开发相关的实习工作。以上是我的自我介绍全部内容，谢谢。
...
哪些gc方法常用在eden区，哪些用在old区

弗洛伊德算法、迪杰斯特拉算法、贝尔曼福特算法，哪个无法解决负权重问题
...
从您hr的专业角度来说，我的简历有什么需要优化的点吗？

为期三周的课题制是什么模式？



1.课题制度是以项目为单位解决问题还是，具体工作是做什么，课题是什么模式？
...
给你一个数组，每次操作清除所有满足`nums[i] < nums[i - 1]`的第i个元素，，问需要操作多少次保持数组递增

### 题目二

给你一个数组s，表示对应坐标轴上的小区位置（正整数），给你另一个数组d，表示核酸检测亭的位置，分配核酸检测亭的位置保证所有小区到离他最近的核酸检测亭之和最小，求最小值
